...
public class Operations
{
    ...
    {
        return ((num >> which >> which >> which >> which >> which >> which >> which >> which) & 255);
    }
    ...
    {
        return (num & ~(15 << which << which << which << which)) | (a_nibble << which << which << which << which);
        //return (num | (15 << which << which << which << which)) & (a_nibble << which << which << which << which);
    }
    ...
    *  they appear in the parameters.
    ...
    {
        return (num != 0) && ((num >> 31) == 0) && ((num & -num) == num);
        //return (num != 0) && ((num) & ~(num & (num | -1))) == -1;
